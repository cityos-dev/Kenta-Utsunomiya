...
public class FileUploadController {
    ...
    public synchronized ResponseEntity<String> handleUpload(final MultipartFile data) throws IOException, UnsupportedMediaTypeStatusException {
        ...
        final String responce = String.format("v1/files/%s", fileid);
        return ResponseEntity.status(HttpStatus.CREATED).header("Location", responce).body(SUCCESS_UPLOAD_MESSAGE);
    }
